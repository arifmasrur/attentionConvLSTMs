...
model.load_state_dict(torch.load('/home/arifm/usda/ConvLSTM.pytorch/Output_ConvLSTM/best_model_ALL_PAIR_corrected.pth', map_location='cpu'))
...
for batch_idx, (inputs, targets) in enumerate(testloader):
      ...
      minimum = 0.03686178 #-1.0623406 #-0.8712145
      maximum = 0.18257238 #11.707237 #0.37115547
      ...
      out_name = "Pair_attentions_corrected" + str(batch_idx) + ".pkl"
      pkl_out = open(os.path.join("/home/arifm/usda/ConvLSTM.pytorch/output/attentions_pair/Non_std", out_name),'wb')
      pickle.dump(output_list, pkl_out)
