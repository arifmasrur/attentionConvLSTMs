...
def main():
    ...
    for epoch in range(config.epochs):
        ...
        test_records, test_records_fire, test_records_Nofire, accuracy_class = test(config, logger, epoch, model, test_loader, criterion)
        ...
        if min_val_loss > test_records**0.5:
          ...
          torch.save(model.state_dict(), "/home/arifm/usda/ConvLSTM.pytorch/Output_ConvLSTM/best_model_ALL_pair_K3.pth")
          counter = 0
