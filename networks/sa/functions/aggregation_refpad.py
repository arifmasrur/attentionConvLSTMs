...
class AggregationRefpad(Function):
    ...
    def forward(ctx, input, weight, kernel_size, stride, padding, dilation):
        ...
        #print("---------------------")
        #print(input_height, padding[0], dilation[0], kernel_size[0], stride[0])
        ...
        #print(output_height, output_width, weight_width)
...
def test_aggregation_refpad():
    ...
    x2 = unfold_j(pad(x)).view(n, c_x // c_w, c_w, pow(kernel_size, 2), out_height * out_width)
