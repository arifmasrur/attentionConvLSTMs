...
model.load_state_dict(torch.load('/home/arifm/usda/ConvLSTM.pytorch/Output_ConvLSTM/best_model_ALL_SCAconvlstm_corrected.pth', map_location='cpu'))
...
def reshape1(inPkl):
    [inPkl] = inPkl
    yyy = []
    for i in range (7): ############# Unlike Patch or Pair-ConvLSTM networks, SCA attentions don't have this dimension. So it will not work in this way...
        yy = []
        for j in range(10):
...
for batch_idx, (inputs, targets) in enumerate(testloader):
      ...
      out_name = "SCA_attentions" + str(batch_idx) + ".pkl"
