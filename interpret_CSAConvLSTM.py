...
model.load_state_dict(torch.load('/home/arifm/usda/ConvLSTM.pytorch/Output_ConvLSTM/best_model_CSA.pth', map_location='cpu'))
...
pickle.dump(ig_mean_10T, open(os.path.join(workspace, "ig_mean_10T.pkl") ,'wb'))
...
df.to_csv("temporal_importances_CSA_ConvLSTM_NEW.csv")
...
def visualize_importances(feature_names, importances, title="Average Feature Importances", plot=True, axis_title="Features"):
    ...
    if plot:
        ...
        plt.savefig("CSAConvLSTM_importance_fire_T10_NEW.png")
