...
from networks.Patch_ConvLSTM import ConvLSTM
...
from utils.functions_Patch5 import train
from utils.functions_Patch5 import valid
from utils.functions_Patch5 import test
...
def main():
    ...
    for epoch in range(config.epochs):
        ...
        if min_val_loss > test_records**0.5:
          ...
          #torch.save(model.state_dict(), "/home/arifm/usda/ConvLSTM.pytorch/Output_ConvLSTM/best_model_ALL_PATCH_5_corrected.pth")
          torch.save(model.state_dict(), "/home/arifm/usda/ConvLSTM.pytorch/Output_ConvLSTM/Corrected_model_PATCH_5_FINAL.pth")
          counter = 0
    ...
    out = open(os.path.join(r"/home/arifm/usda/ConvLSTM.pytorch/Output_ConvLSTM", "Patch5_ConvLSTM_losses_10T_FINAL.pkl") ,'wb')
