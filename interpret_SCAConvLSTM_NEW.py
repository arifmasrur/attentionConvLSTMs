...
class CBAM(nn.Module):
    ...
    def __init__(self, in_channels, num_features, kernel_size, padding, stride, reduction_ratio=8, pool_types=['avg', 'max', 'lp', 'lse'], no_spatial=False):
        ...
        self.ChannelGate = ChannelGate(num_features, reduction_ratio, pool_types)
...
class ConvLSTMBlock(nn.Module):
    def __init__(self, in_channels, num_features, kernel_size=3, padding=1, stride=1):
        ...
        self.conv = self._make_layer(in_channels+num_features+3, num_features*4,
...
model.load_state_dict(torch.load('/home/arifm/usda/ConvLSTM.pytorch/Output_ConvLSTM/best_model_ALL_SCAnewConvlstm_corrected.pth', map_location='cpu'))
...
#ig_attr_test = ig.attribute(input.float().to(config.device),  n_steps=1)
...
pickle.dump(ig_array_10T, open(os.path.join(workspace, "ig_Grids_10T_FIRE_SCA_NEW.pkl") ,'wb'))
pickle.dump(ig_mean_10T, open(os.path.join(workspace, "ig_GridsMean_10T_FIRE_SCA_NEW.pkl") ,'wb'))
...
#
##df.to_csv("temporal_importances_fire_SCA_ConvLSTM_NEW.csv")
#
#
#
### +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Feature Importance +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ 
...
#
#        
#        #plt.savefig("SCAConvLSTM_importance_fire_T10_NEW.png")
#        
