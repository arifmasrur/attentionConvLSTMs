...
from networks.san_patch5 import *
...
model.load_state_dict(torch.load('/home/arifm/usda/ConvLSTM.pytorch/Output_ConvLSTM/best_model_ALL_PATCH_5_corrected.pth', map_location='cpu'))
...
for batch_idx, (inputs, targets) in enumerate(testloader):
      ...
      minimum = 0.14145032 #-1.0623406 #-0.8712145
      maximum = 13.000918 #11.707237 #0.37115547
      ...
      out_name = "Patch5_attentions_corrected" + str(batch_idx) + ".pkl"
      pkl_out = open(os.path.join("/home/arifm/usda/ConvLSTM.pytorch/output/attentions_patch5/Non_std", out_name),'wb')
      pickle.dump(output_list, pkl_out)
...
print("Min and max of ALL attentions: ", allAttentions.min(), allAttentions.max())
