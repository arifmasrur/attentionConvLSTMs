...
from utils.functions_CSA import train
from utils.functions_CSA import valid
from utils.functions_CSA import test
...
def main():
    ...
    for epoch in range(config.epochs):
        ...
        if min_val_loss > test_records**0.5:
          ...
          torch.save(model.state_dict(), "/home/arifm/usda/ConvLSTM.pytorch/Output_ConvLSTM/Corrected_model_CSAnewConvlstm_FINAL.pth")
          counter = 0
        else:
          counter += 1
    ...
    out = open(os.path.join(r"/home/arifm/usda/ConvLSTM.pytorch/Output_ConvLSTM", "CSAnew_ConvLSTM_losses_10T_FINAL.pkl") ,'wb')
