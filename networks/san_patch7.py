...
from networks.sa import functional_patch7 as F1
...
class SAM(nn.Module):
    def __init__(self, sa_type, in_planes, rel_planes, out_planes,  share_planes=4, kernel_size=7, stride=1, dilation=1):
        ...
        if sa_type == 0:
            ...
            self.unfold_j = nn.Unfold(7, dilation=1, padding=1, stride=stride)
